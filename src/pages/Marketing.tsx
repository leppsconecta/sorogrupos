...
import { JobEditModal, ActionsModal, JobSelectorModal } from '../components/modals';
              ...
              <div className="bg-[#008069] dark:bg-[#202c33] h-14 absolute top-0 left-0 right-0 px-4 flex items-center justify-between z-10 shadow-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div className="w-8 h-8 rounded-full bg-slate-200 overflow-hidden">
                    <img src="https://ui-avatars.com/api/?name=SoroEmpregos&background=random" alt="Avatar" className="w-full h-full object-cover" />
                  </div>
