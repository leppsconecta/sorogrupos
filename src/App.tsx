          ...
          <div className={showDashboardUI ? "w-full max-w-7xl mx-auto" : "w-full h-full"}>
            <React.Suspense fallback={
              ...
              <Routes>
                ...
                <Route path="/painel/vagas" element={!isLoggedIn ? <Navigate to="/" /> : <Vagas />} />
                <Route path="/painel/grupos" element={!isLoggedIn ? <Navigate to="/" /> : <Grupos externalTrigger={triggerCreateGroup} {...commonProps} />} />
