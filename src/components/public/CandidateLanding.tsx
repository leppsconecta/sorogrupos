...
import { Search, Loader2, Users, MapPin, ArrowRight, Briefcase, Zap, CheckCircle2, Clock } from 'lucide-react';
    ...
    return (
        <div className="bg-slate-50 min-h-screen font-sans">
            ...
            <section className="py-12 px-4 md:px-8 max-w-7xl mx-auto">
                ...
                <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6 text-center max-w-3xl mx-auto mb-12">
                    <p className="text-blue-800 font-medium flex items-center justify-center gap-2">
                        <Clock size={20} />
                        As vagas são atualizadas diariamente. Volte sempre para conferir novidades!
                    </p>
                </div>
            </section>
