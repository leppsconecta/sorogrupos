        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
            ...
            <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] animate-scaleIn ring-1 ring-slate-100">
                ...
                <div className="p-6 pb-4 border-b border-slate-100 relative bg-white">
                    {/* Job Code - Top Left/Right? User said Top Right. But Close button is Top Right. Let's put it next to close button or below it. Or on the left side? User said "canto superior direito" (top right). Maybe below the X or to the left of the X. */}
                    {/* Let's put it absolute top-left or just flex row with the title. */}
                    {/* Actually, let's put it as a badge in the top-right corner, effectively utilizing the space. */}
                    ...
                    <div className="mt-8"> {/* Added margin top to clear the absolute positioned elements */}
